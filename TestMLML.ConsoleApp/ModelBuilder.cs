...
namespace TestMLML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\kerut\Desktop\file.csv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options() { NumberOfIterations = 100, LearningRate = 0.2482878f, NumberOfLeaves = 3, MinimumExampleCountPerLeaf = 10, UseCategoricalSplit = true, HandleMissingValue = true, MinimumExampleCountPerGroup = 100, MaximumCategoricalSplitPointCount = 16, CategoricalSmoothing = 1, L2CategoricalRegularization = 0.1, Booster = new GradientBooster.Options() { L2Regularization = 0.5, L1Regularization = 1 }, LabelColumnName = "fare_amount", FeatureColumnName = "Features" });
